...
<head>
    ...
    <title>Formation Java - e-school</title>
</head>
...
<body>
    ...
    <main id="formation">
        <section class="container mt-4">
            <h1 class="text-center pb-5">Formation en développement Java</h1>
            <div class="row flex-column flex-md-row shadow-sm mb-4">
                <p class="text-center pb-5">Cette formation vous permet de maîtriser le langage Java et de développer des applications robustes et évolutives.</p>

                <div class="col-12 col-md-8 mb-4">
                    <img src="./assets/java-example.jpg" class="img-fluid rounded" alt="Exemple de formation Java">
                </div>
                <div class="col-12 col-md-4">
                    <h2 class="text-center pb-5">Détails de la formation</h2>
                    <ul class="list-group">
                        <li class="list-group-item">Durée : 80 Heures</li>
                        <li class="list-group-item">Langues : Français</li>
                        <li class="list-group-item">Contenu : 40 exercices pratiques</li>
