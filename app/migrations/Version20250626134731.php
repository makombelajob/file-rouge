 ...
 */
final class Version20250626134731 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE categories_courses (categories_id INT NOT NULL, courses_id INT NOT NULL, INDEX IDX_81AF8BECF9295384 (courses_id), INDEX IDX_81AF8BECA21214B7 (categories_id), PRIMARY KEY(categories_id, courses_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = '' 
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categories_courses ADD CONSTRAINT FK_81AF8BECA21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON UPDATE NO ACTION ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE categories_courses ADD CONSTRAINT FK_81AF8BECF9295384 FOREIGN KEY (courses_id) REFERENCES courses (id) ON UPDATE NO ACTION ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
