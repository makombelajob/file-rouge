...
return [
    ...
    'app_courses' => [['id'], ['_controller' => 'App\\Controller\\CoursesController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/courses']], [], [], []],
    'app_formation' => [['id'], ['_controller' => 'App\\Controller\\FormationController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/formation']], [], [], []],
    ...
    'App\Controller\CoursesController::index' => [['id'], ['_controller' => 'App\\Controller\\CoursesController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/courses']], [], [], []],
    'App\Controller\FormationController::index' => [['id'], ['_controller' => 'App\\Controller\\FormationController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/formation']], [], [], []],
